...
export class MerchantMoeV2Library {
    ...
    static getIds(percentDepth: number, currentBin: number, BinStep: number,
    ): number[] {
  ...
  //   }
    ...
    static getSlippages(
      ...
      const token0Slippage = MerchantMoeV2Library.GetAmountXDumpable(
        currentBin,
        BinStep,
        bins,
        token0Decimals,
      ...
      const token1Slippage = MerchantMoeV2Library.GetAmountYDumpable(
        currentBin,
        BinStep,
        bins,
        token0Decimals,
